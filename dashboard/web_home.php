...
<head>
    ...
    <title><?php echo $_SESSION['user_names']; ?> - Welcome to Our Subscription Platform</title>
</head>
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    if(isset($_GET['action']) && $_GET['action']!=''){
                        ...
                        if($action=='homepage'){
                            ...
                            include 'App/Views/Home/add_blog.php';
                        }
                        else{
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                             Copyright © <?php echo date('Y'); ?>. All rights reserved to <a href="../"> Gasogi United FC</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
